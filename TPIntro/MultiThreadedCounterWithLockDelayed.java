...
public class MultiThreadedCounterWithLockDelayed extends Thread {
    ...
    public MultiThreadedCounterWithLockDelayed(String aName) {
    ...
    public void run() {
        ...
        for(int i=1; i<=1000; i++) {
            ...
            MultiThreadedCounterWithLockDelayed.count++ ;
            myLock.writeLock().unlock();
            if (i%200==0) {
                System.out.println(this.threadName + ": i = " + i + " count = " + count);
            }
        } // EndFor
